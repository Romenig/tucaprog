...
Blockly.Flyout.prototype.show = function(a) {
	...
	//ROMENIG
	var treco1 = $("#blocklyFlyoutBackground");
	var treco2 = $("#blocklyTreeRoot");

	if(a[0].getAttribute("type") == "riscar"){
		$(".blocklyFlyoutBackground").css({ fill: "#e67e22" });
	} else if(a[0].getAttribute("type") == "mover"){
		$(".blocklyFlyoutBackground").css({ fill: "#c0392b" });
	} else if(a[0].getAttribute("type") == "repetir"){
		$(".blocklyFlyoutBackground").css({ fill: "#16a085" });
	} else{
		$(".blocklyFlyoutBackground").css({ fill: "#47add9" });
	}
...
Blockly.Toolbox.prototype.addColour_ = function(a) {
    ...
    for (var b = 0, c; c = a[b]; b++) {
        ...
        if (d) {
            var e = this.hasColours_ ? "25px solid " + (c.hexColour || "#ddd") : "none";
...
Blockly.Css.CONTENT = [".blocklySvg {", "background-color: #fff;", "outline: none;", "overflow: hidden;", "position: absolute;", "display: block;", "}", ".blocklyWidgetDiv {", "display: none;", "position: absolute;", "z-index: 99999;", "}", ".injectionDiv {", "height: 100%;", "position: relative;", "overflow: hidden;", "touch-action: none", "}", ".blocklyNonSelectable {", "user-select: none;", "-moz-user-select: none;", "-ms-user-select: none;", "-webkit-user-select: none;", "}", ".blocklyWsDragSurface {", "display: none;",
    ...
    "margin: 0;", "padding: 0;", "}", ".blocklyCommentTextarea {", "background-color: #ffc;", "border: 0;", "margin: 0;", "padding: 2px;", "resize: none;", "}", ".blocklyHtmlInput {", "border: none;", "border-radius: 4px;", "font-family: sans-serif;", "height: 100%;", "margin: 0;", "outline: none;", "padding: 0 1px;", "width: 100%", "}", ".blocklyMainBackground {", "stroke-width: 0;", "stroke: #c6c6c6;", "}", ".blocklyMutatorBackground {", "fill: #fff;", "stroke: #ddd;", "stroke-width: 1;", "}", ".blocklyFlyoutBackground {", "fill: #ddd;",
    "fill-opacity: .4;", "}", ".blocklyTransparentBackground {", "opacity: 0;", "}", ".blocklyMainWorkspaceScrollbar {", "z-index: 20;", "}", ".blocklyFlyoutScrollbar {", "z-index: 30;", "}", ".blocklyScrollbarHorizontal, .blocklyScrollbarVertical {", "position: absolute;", "outline: none;", "}", ".blocklyScrollbarBackground {", "opacity: 0;", "}", ".blocklyScrollbarHandle {", "fill: #ccc;", "}", ".blocklyScrollbarBackground:hover+.blocklyScrollbarHandle,", ".blocklyScrollbarHandle:hover {", "fill: #bbb;", "}", ".blocklyZoom>image {",
